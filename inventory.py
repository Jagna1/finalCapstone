...
#Outside this class create a variable with an empty list. This variable will be used to store a list of shoes object
...
# Used try/finally in case the file does not open on user end
